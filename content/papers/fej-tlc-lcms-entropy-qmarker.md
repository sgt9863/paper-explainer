---
title: 多次元クロマトグラフィー指紋融合と機械学習によるTCM Q-marker探索——エントロピーに基づく特徴量評価
slug: fej-tlc-lcms-entropy-qmarker
source_pdf: 1-s2.0-S0039914026001554-main.pdf
doi: https://doi.org/10.1016/j.talanta.2026.129500
level: practitioner
date: 2026-07-03
tags: [方剤・中成薬, QC・品質評価, Q-marker, 指紋分析, 質量分析, HPLC・UPLC, ケモメトリクス, 機械学習・データ処理]
digest_tagline: TLC×LC-HRMSの多次元指紋(各1700超の特徴量)をランダムフォレストと修正エントロピーで解析し複方阿膠漿(FEJ)のQ-markerを客観的に選定
digest_stats: [IF（2024）|6.1, 対象|複方阿膠漿(FEJ)とその製造中間体(FEJM), 特徴量|TLC・LC-HRMS各1700超, 選定パターン|FEJ5種／FEJM7種, LC-HRMS同定|826化合物(うち15トリテルペノイドサポニン)]
digest_points: [TLC(RGB画素)とLC-HRMS(保持時間・m/z)の多次元指紋データセットをランダムフォレストで解析しFEJで5パターン・製造中間体(FEJM)で7パターンの特徴的バンドを選定, 線形フィッティングモデルでTLC指紋の再現性(コサイン類似度)を検証し修正エントロピー値と障害因子によりマーカー化合物を客観的に順位付け, ロベチオール(lobetyol)をFEJ最終製品の障害度最大(0.260)のQ-marker ジンセノシドRfを製造中間体(0.231)のQ-markerとして同定しRh1・Rg1/Rg2/Rg3混合パターンを両者共通マーカーとして特定]
digest_chart_label: 障害因子(obstacle degree)の最高値比較（FEJ vs 製造中間体FEJM）
digest_chart: [ロベチオール(FEJ)|0.260, ジンセノシドRf(FEJM)|0.231]
summary: 複方阿膠漿(FEJ)とその製造中間体(FEJM)について、TLCとLC-HRMSの多次元クロマトグラフィー指紋(各1700超の特徴量)を構築し、ランダムフォレストによる特徴選択・線形フィッティングによるシミュレーション検証・修正エントロピー値＋障害因子による客観的評価を統合したパイプラインで、ロベチオール(FEJ)とジンセノシドRf(FEJM)を主要Q-markerとして同定した研究の全訳（＋訳者補足）。
---
