...
> 以下は原論文から抽出した図。キャプションは訳者による要約。

![図1. QAMS研究の対象概念図。(左)単味生薬医薬品、(右)中薬複方製剤。単一マーカーで代替定量する考え方はどちらにも適用可能。](assets/qams-single-marker-review/fig1a.jpeg)
![（続き）中薬複方製剤の例（六味地黄丸カプセル剤のパッケージ）。](assets/qams-single-marker-review/fig1b.jpeg)
