...
![図1. 対象6化合物（ポリダチン、レスベラトロール、エモジン-8-O-β-D-グルコピラノシド、エモジン、バイカリン、バイカレイン）の構造式・分子式とUV吸収スペクトル。](assets/ssdmc-rrf-uv-wavelength-concentration-polygonum-cuspidatum/fig1.png)
...
![図2. SSDMC法による4成分定量のための最適検出波長予測（ピーク面積比 対 波長）。](assets/ssdmc-rrf-uv-wavelength-concentration-polygonum-cuspidatum/fig2.png)
...
![図3. 応答係数（RF）の濃度依存性。OSP法とLRE法の比較（挿入図A・Bは低濃度域の拡大）。](assets/ssdmc-rrf-uv-wavelength-concentration-polygonum-cuspidatum/fig3.png)
...
![図4. 代表的HPLCクロマトグラム。(A) 混合標準溶液（エモジンE・レスベラトロールR・エモジン配糖体EG・ポリダチンP）、(B) 試料。](assets/ssdmc-rrf-uv-wavelength-concentration-polygonum-cuspidatum/fig4.png)
