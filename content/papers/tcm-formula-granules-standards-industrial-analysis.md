---
title: 産業化実践に基づく500余種の中薬配方顆粒（漢方エキス顆粒）標準の剖析と応用の考察
slug: tcm-formula-granules-standards-industrial-analysis
source_pdf: 基于产业化实践的500余种...配方颗粒标准剖析及应用思考_刘勇.pdf
doi: https://doi.org/10.19540/j.cnki.cjcmm.20241216.301
level: practitioner
date: 2026-07-24
published: 2025
tags: [方剤・中成薬, 生薬, QC・品質評価, 規制・ガイドライン, レビュー]
digest_tagline: 中国の中薬配方顆粒（単味エキス顆粒）は2021年の《技術要求》以降 国家標準296＋江西省標準247を企業が3年運用——出膏率・特徴図・含量の三大指標を軸に 543標準を炮制類別・出膏率・揮発油・安全性・含量・国省差の6視点で解剖し 生産現場の勘所を審評データで示す
digest_stats: [IF|該当なし（中国中药杂志・中文誌）, 主題|中薬配方顆粒標準の産業的解析, 発行|2025年（中国中药杂志50巻5号）, 解析対象|国家標準296＋江西省標準247＝計543, 三大指標|出膏率／含量・転移率／特徴図, 引用|26件]
digest_points: [配方顆粒＝単味飲片を水提・分離・濃縮・乾燥・造粒したエキス顆粒で「標準湯剤」を物質基準に飲片との臨床一致性を担保——出膏率・含量および含量転移率・特徴図の三大指標が最重要の品質表征, 標準は国家標準ほど後発バッチほど厳格（特徴峰個数は第1批平均7→第5批11 相対ピーク面積規定の採用率も上昇）で 省標（平均6峰・指認率48.4%）は国標より明確に緩い——同一品目でも省→国標転換で浸出物・含量・特徴峰が軒並み強化される, 含量限度は≥15バッチ標準湯剤の「平均±3SD（または平均の70〜130%）」で設定され 実生産の指標成分平均転移率は約30%（10〜60%が約70%）——薬典飲片最低含量での投料は不合格リスクがあり品目ごとに高い購買標準が要る]
summary: 中薬配方顆粒（中薬フォーミュラ顆粒／単味の漢方エキス顆粒）は 2021年に国家薬監局が《中薬配方顆粒質量控制与標準制定技術要求》を発布して以降 国家薬典委員会が国家標準296件を公布し各省も省級標準で補完している。本稿（江西一方天江・広東一方の企業技術者による2025年の学術探討・中国中药杂志50巻5号）は 実際に配方顆粒の標準・工程業務に携わった立場から 公布済みの国家標準296件＋江西省標準247件（計543）を ①品目来源と炮制類別 ②出膏率と揮発油工程 ③安全性指標 ④特徴図／指紋図 ⑤含量測定 ⑥国標・省標の制定差 の各層で統計解析し 7つの詳細な表とともに 配方顆粒の生産品質管理で重点的に注意すべき内容（薬材GAP・飲片炮制・全過程量質伝達・データ蓄積）への提言をまとめた総説の全訳（＋訳者補足）。
---
...
> 補足: **中薬配方顆粒（中薬フォーミュラ顆粒）** ＝日本でいう「単味の漢方エキス顆粒」に相当する。単味の中薬飲片を、水で抽出→分離→濃縮→乾燥→造粒して作る顆粒で、中医の臨床処方に従って複数の単味顆粒を調合し、患者が湯に溶かして服用する。伝統的な「煎じ薬（湯剤）」を顆粒で置き換える現代的な剤形である。本稿の著者らは配方顆粒を実際に製造する **一方（Yifang）グループ企業の技術者**であり、当局の標準（規格）を現場で運用してきた経験に基づいて、公布された標準の統計的特徴と生産上の勘所を論じている。日本の読者には、**エキス製剤メーカーの品質担当者が、公定規格543品目を統計解析して「規格の作られ方の癖」と「製造での引っかかりどころ」を解説した実務論文**、と考えると位置づけが分かりやすい。
...
《技術要求》は、中薬配方顆粒が **湯剤の基本的属性を備え**、水のみを抽出溶媒として用い、**標準湯剤を物質基準として配方顆粒と飲片の臨床的一致性を測り**、**出膏率・有効（または指標）成分の含量および含量転移率・特徴図の三大指標を、配方顆粒の最も重要な品質表征とする**ことを明確に要求した。これは中薬配方顆粒の品質管理の科学性・厳密性を十分に体現しており、薬品安全監督管理の「四つの最も厳しく」の要求の生き生きとした表れでもある。
...
**煅磁石を例に**とると、配方顆粒への調製は難度が大きく[5]、出膏率はわずか0.1%〜1.0%で、12 500 g の飲片から1000 g の配方顆粒を作ると、1 g の配方顆粒は飲片12.5 g に相当する。煅磁石の臨床用量は9〜30 g で、標準製法に従えば服用する配方顆粒の用量は1.0〜2.4 g となる。しかし輔料が1:1を超えない原則を満たそうとすると、最少でも50 000 g の飲片から1000 g の配方顆粒を作る必要があり、1日服用量はわずか0.18〜0.60 g となって、包装と臨床調合の用量の正確性を管理しがたい。
...
1. 国家药品监督管理局. 国家药监局关于发布《中药配方颗粒质量控制与标准制定技术要求》的通告（2021年第16号）［EB/OL］. (2021-02-11).
2. 江西省药品监督管理局. 关于印发《关于进一步优化药品审评审批促进医药产业高质量发展的若干措施》的通知［EB/OL］. (2024).
3. 安徽省医疗保障局. 关于印发《安徽省支持中药配方颗粒产业发展的意见》的通知［EB/OL］.
4. 黄丽玲, 邹洵, 刘立辉, 等. 不同灭菌方式对当归粉阿魏酸保留率的影响［J］. 食品与药品, 2024, 26(3): 227.
5. 王晨, 时政, 刘钱, 等. 不适宜制备中药配方颗粒的中药材品种探讨［J］. 中草药, 2021, 52(18): 5775.
6. 赵凯, 王一飞, 李新, 等. 酸枣仁油研究应用进展［J］. 中国粮油学报, 2022, 37(12): 311.
7. 刘世军, 曹安星, 唐志书, 等. 大枣配方颗粒成型工艺研究［J］. 西部中医药, 2017, 30(11): 62.
8. 孙如煜, 谭佳威, 高艳, 等. 牡丹皮提取及包合工艺研究［J］. 环球中医药, 2018, 11(10): 1533.
9. 王雅琪, 杨园珍, 伍振峰, 等. 中药挥发油传统功效与现代研究进展［J］. 中草药, 2018, 49(2): 455.
10. 江晓霞, 刘红宁, 姚子恒, 等. 中药挥发油的粉末化技术研究进展［J］. 中成药, 2022, 44(11): 3560.
11. 赵剑锋, 张雪, 祁进, 等. 指纹图谱与特征图谱技术在中药配方颗粒国家标准中的应用回顾性分析［J］. 中国现代应用药学, 2023, 40(9): 1278.
12. 李军, 姜华, 张延萍, 等. 柴胡水煎液中柴胡皂苷a和d的溶出与转化差异［J］. 中国药学杂志, 2014, 49(19): 1692.
13. 于姗姗, 郭东晓, 张秋红, 等. 从质量标准复核和审评视角浅析中药配方颗粒标准制定工作（Ⅲ）［J］. 中草药, 2022, 53(14): 4256.
14. 左甜甜, 刘静, 王莹, 等. 中药外源性有害物质和内源性有毒成分风险评估技术体系研究进展及展望［J］. 中国现代中药, 2023, 25(6): 1179.
15. 赵思源, 曹德艳, 王焱, 等. 21种中药材中黄曲霉毒素B1的污染状况及致癌风险分析［J］. 现代医药卫生, 2022, 38(23): 3961.
16. 张萍, 郭晓晗, 金红宇, 等. 2022年全国中药材及饮片质量分析概况［J］. 中国现代中药, 2023, 25(10): 2046.
17. 张丽霞, 牟燕, 杨美华, 等. 植物生长调节剂在中药材中的应用及安全性评价研究进展［J］. 中国中药杂志, 2020, 45(8): 1824.
18. 魏建和, 王文全, 王秋玲, 等. 《中药材生产质量管理规范》修订背景及主要修订内容［J］. 中国现代中药, 2022, 24(5): 743.
19. 秦昆明, 曹岗, 杨冰, 等. 基于组分结构理论的中药炮制现代研究进展［J］. 中国科学: 生命科学, 2019, 49(2): 129.
20. 刘远俊, 林荣楷, 陈丹燕, 等. 苍耳子炮制前后饮片及标准汤剂的特征图谱和成分差异研究［J］. 中药材, 2023, 46(6): 1393.
21. 徐文娟, 董海鹏, 韩婷, 等. 蒸制工艺对酒女贞子外观性状和主要成分的影响［J］. 中国现代中药, 2021, 23(8): 1437.
22. 广东省药品监督管理局. 关于省外已发布中药配方颗粒质量标准转化为本省试行标准的工作程序的通告［EB/OL］. (2024).
23. 河北省药品监督管理局. 关于规范省外已发布中药配方颗粒质量标准转化为本省试行标准工作程序的通告［EB/OL］. (2022-03-24).
24. 苗妍, 路露, 张璐, 等. 中药配方颗粒省级标准的制定情况及其特点分析［J］. 中国实验方剂学杂志, 2023, 29(14): 157.
25. 郭春彬, 刘斗. 中药配方颗粒跨省备案存在的问题及原因分析［J］. 药学研究, 2024, 43(9): 931.
26. 熊皓舒, 王鐾璇, 侯健, 等. 生成式人工智能（AI）在中药智能制造及供应链中的应用场景设计与展望［J］. 中国中药杂志, 2024, 49(14): 3963.
