---
title: 食事成分・完成剤形中の非揮発性ショウガ成分の定量（AOAC公定法2018.04・First Action）——LC-UV法とSMPR 2017.012適合の検証
slug: aoac-2018-04-ginger-nonvolatile-constituents-lc-uv
source_pdf: c6055278-jaoacint.190004.pdf
doi: https://doi.org/10.5740/jaoacint.19-0004
drive_url: (未アップロード：ユーザー返却PDF)
level: researcher
date: 2026-07-08
published: true
tags: [生薬, QC・品質評価, HPLC・UPLC, 多成分定量, メソッド開発・QbD, 規制・薬事]
digest_tagline: ショウガ（生姜）の非揮発性8成分（ジンゲロール／ショウガオール／パラドール／ジンゲロン）をLC-UVで12分定量――AOAC SMPR 2017.012を満たしFirst Action公定法に採択
digest_stats: [IF|1.7（J. AOAC Int.・JCR2024・Q2）, 生薬|ショウガ（生姜・Zingiber officinale）, 定量成分|非揮発性8成分, 分析時間|12分（USP法29分／ISO法40分を短縮）, 検証|単一施設バリデーション・回収率91.1-103.2%・RSDr<5%・RSDR<8%]
digest_points: [6-/8-/10-ジンゲロール・6-/8-/10-ショウガオール・6-パラドール・ジンゲロンの非揮発性8成分をKinetex C18・230nm・12分グラジエントでベースライン分離しUSP法(282nm/29分)・ISO法(280nm/40分)を短縮改良, 抽出溶媒を6種比較し80%メタノール（クエン酸pH5酸性水20%）が最良／Youden頑健性試験で7因子を最適化しAOAC単一施設バリデーションプロトコルで検証, 直線性R²>0.999・スパイク回収率90-107%以内・RSDr≤5%・RSDR≤8%をショウガ根粉末/乾燥エキス/錠剤/カプセル/軟カプセル/オレオレジン等で満たしAOAC First Action公定法2018.04に採択（偽和物ガランガル根を偽薬に使用）]
digest_chart_label: 分析時間の短縮（従来法→本AOAC 2018.04法）
digest_chart: [ISO法の分析時間(分)|40, USP法の分析時間(分)|29, 本AOAC 2018.04法(分)|12]
summary: ショウガ（生姜・Zingiber officinale）根茎とその乾燥エキス・精製非揮発性成分を含む食事成分・栄養補助食品の品質管理のため、非揮発性8成分（6-/8-/10-ジンゲロール、6-/8-/10-ショウガオール、6-パラドール、ジンゲロン）をLC-UVで同時定量する分析法を、AOAC標準法性能要件（SMPR 2017.012）に沿って開発・検証した論文の解説。Kinetex C18カラム・検出波長230nm・12分グラジエントでベースライン分離を達成し、USP法（282nm・29分）・ISO法（280nm・40分）を短縮改良。抽出溶媒6種の比較で80%メタノール（クエン酸でpH5に酸性化した水20%）が最良と判明、Youden頑健性試験で7因子を最適化。AOAC単一施設バリデーションで直線性（R²>0.999）・スパイク回収率91.1-103.2%・併行精度RSDr<5%・室間精度RSDR<8%を、粉末・乾燥エキス・錠剤・カプセル・軟カプセル・オレオレジン等の多様なマトリックスで確認し、AOAC専門審査委員会（ERP）がFirst Action Official Method 2018.04に採択した。
---

<!--
You H, Ireland B, Moeszinger M, Zhang H, Snow L, Krepich S, Takagawa V.
Determination of Select Nonvolatile Ginger Constituents in Dietary Ingredients and
Finished Dosage Forms, First Action 2018.04. J AOAC Int 2020;103(1):124-131.
doi:10.5740/jaoacint.19-0004 の全訳密度日本語版。
-->
...
![図1. クロマトグラム。(a) 不揮発性ショウガ成分の標準混合物、(b) 試料251、(c) 試料063（主要ピーク: ジンゲロン・6/8/10-ジンゲロール・6/8-ショウガオール・6-パラドール等）。](assets/aoac-2018-04-ginger-nonvolatile-constituents-lc-uv/fig1.png)
...
![図2018.04A. ショウガ根茎粉末試料中の総不揮発性ショウガ成分（% w/w純度）——各抽出溶媒の比較。](assets/aoac-2018-04-ginger-nonvolatile-constituents-lc-uv/fig2.png)
