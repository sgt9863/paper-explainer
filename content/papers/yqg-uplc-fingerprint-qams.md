...
![Figure 4. 17ロットYQGの指紋の技術的解析（PCAスコアプロット）。緑（群1）：中央にまとまるロット、青（群2）：S1・S5・S7・S10。R2X（第1成分）=0.606、R2X（第2成分）=0.154、楕円はHotelling's T2（95%）。](assets/yqg-uplc-fingerprint-qams/fig4-pca.jpeg)
