...
digest_stats: [IF|該当なし（Pharmaceutical Regulatory Affairs・オープンアクセス）, 発表|2019年（Veiled Therapeutics・元FDA CDER・オハイオ大学）, 著者|McChesney（天然物研究歴50年）＋Dou（元FDAボタニカル審査チーム）, 承認例|Veregen＝シネカテキン（緑茶カテキン・2006）と Fulyzaq／Mytesi＝クロフェレマー（Croton lechleri 由来オリゴマー性プロアントシアニジン・2012）, 規格|Polyphenon E の EGCG 51.4〜65%・総カテキン89.4〜89.5%, 参考文献|34件]
