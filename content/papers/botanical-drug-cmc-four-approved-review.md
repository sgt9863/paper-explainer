---
title: 植物性医薬品（ボタニカルドラッグ）のIND・NDA開発におけるCMCの課題と解決策 — FDA承認4製品から得られた教訓
slug: botanical-drug-cmc-four-approved-review
source_pdf: Botanical+Drugs+2026.1.02+Luo.pdf
doi: https://doi.org/10.65239/botanicaldrugs.2026.02
drive_file_id: 1rAw9BH9JI7gFY6RfVQ0N0AFzSv2LaeGE
drive_url: https://drive.google.com/file/d/1rAw9BH9JI7gFY6RfVQ0N0AFzSv2LaeGE/view
level: practitioner
date: 2026-07-07
published: 2026
tags: [生薬, 規制・薬事, レビュー]
digest_tagline: FDA承認の処方箋ボタニカルドラッグ4製品を題材に、単一分子薬とは異なる「証拠の総体(totality-of-evidence)」型CMC/品質保証の枠組みを解剖したレビュー
digest_stats: [誌|Botanical Drugs 2026;1:02（新興誌・IF未収載）, 種別|CMC/薬事レビュー, 対象|FDA承認4製品, 枠組み|証拠の総体(totality-of-evidence), 期間|2006→2023の承認蓄積]
digest_points: [ボタニカルドラッグは化学的に複雑で単一分子薬のCMC枠に収まらない——FDAは2004/2016の2つのガイダンスとCDER内の専門審査班(BRT)で「fit-for-purpose」な承認経路を構築した, 承認4製品(Veregen/Fulyzaq・Mytesi/NexoBrid/Filsuvez)は原料の上流管理・化学的特徴づけ・機序に即したバイオアッセイ・多バッチ/多用量の臨床データを積み上げる「証拠の総体」で品質を保証, 分子的確実性の代わりに集合的証拠で同等の患者保護を達成する枠組みは薬事の壁であると同時に模倣困難な事実上のIP防御にもなる]
summary: FDAが承認した4つの処方箋ボタニカルドラッグ(Veregen/Fulyzaq・Mytesi/NexoBrid/Filsuvez)を題材に、単一分子薬(NCE)とは構造的に異なるCMC・品質保証の課題と、それを解いた「証拠の総体(totality-of-evidence)」アプローチを整理したレビュー(Botanical Drugs 2026)。原料の産地・品種制限やGACP、臨床バッチ由来の規格設定、機序に即した機能アッセイ(クロライドチャネル阻害・タンパク分解活性)、多用量・多バッチの臨床データがどう組み合わさって承認を支えたかを製品別に全訳し、5つの一般化パターンとNCE経路との比較・産業界の誤解・IP保護までを解説する。
---
...
**利益相反**: 著者は本原稿の内容に関連する財務的・その他の利益相反がないことを宣言する。
**倫理声明**: 該当なし。
