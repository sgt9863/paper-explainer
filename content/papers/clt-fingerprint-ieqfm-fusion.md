...
![図1. (A)HPLCでの試料・標準溶液クロマトグラム、(B)GCでの試料・標準溶液クロマトグラム、(C)含量変動のバイオリンプロット、(D)製造業者別の分布。](assets/clt-fingerprint-ieqfm-fusion/fig1.jpeg)
...
![図2. (A)35バッチCLTの220nm指紋、(B)260nm指紋、(C)(D)SeとPeの変動。](assets/clt-fingerprint-ieqfm-fusion/fig2.jpeg)
...
![図3. (A)220nm指紋、(B)260nm指紋、(C)220–260nmタンデム指紋、(D)220–260nmオフライン波長切替指紋、(E)(F)220–260nm融合指紋。](assets/clt-fingerprint-ieqfm-fusion/fig3.jpeg)

![図4. 異なる条件下でのI値。(A)グラジエント条件比較、(B)〜(D)関連パラメータ。](assets/clt-fingerprint-ieqfm-fusion/fig4.jpeg)
...
![図5. (A)生UVスペクトルプロファイルとCCM処理の模式図、(B)35バッチのUV量子指紋、(C)PLSRモデリング結果。](assets/clt-fingerprint-ieqfm-fusion/fig5.jpeg)
