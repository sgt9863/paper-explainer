...
![図1. AQbDに関する科学論文数の推移（2010–2018）。](assets/aqbd-lc-method-development-overview-review/fig1.png)

## 2. AQbDの理論的背景

![図2. AQbDワークフロー（ATP定義→リスク評価→スクリーニング設計→最適化→頑健性→設計空間MODR）。](assets/aqbd-lc-method-development-overview-review/fig2.png)
...
![図3. 3因子2水準の実験計画。(a) 完全実施要因計画（8実験）、(b) 一部実施要因計画、(c) 中心複合計画。](assets/aqbd-lc-method-development-overview-review/fig3.png)
...
![図4. 設計空間（MLR）。pH×カラム温度に対する臨界分離度Rs,critの不合格確率（%）。](assets/aqbd-lc-method-development-overview-review/fig4.png)
...
![図5. AQbDで開発したHILIC法で得たシミュレーションクロマトグラム（ビラスチンと2分解不純物の分離）。](assets/aqbd-lc-method-development-overview-review/fig5.png)
