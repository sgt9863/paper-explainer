...
level: practitioner
date: 2026-06-28
tags: [生薬, QC・品質評価, HPLC・UPLC]   ← 下の「タグ語彙」から選ぶ（新語をむやみに増やさない）
...
タグ語彙（この中から選ぶ。新語は本当に必要なときだけ足す）:
  対象     … 生薬 / 方剤・中成薬
  手法     … HPLC・UPLC / 質量分析 / 分光法 / 指紋分析 / QAMS / 多成分定量
  解析     … ケモメトリクス / 機械学習・データ処理 / ネットワーク薬理
  テーマ   … QC・品質評価 / Q-marker / メソッド開発・QbD / 製造法 / スペクトル効果 / 薬効・薬理 / 規制・薬事
  形式     … レビュー
（関連論文は共通タグの希少度で自動リンクされるので、内容に合うタグを正確に付けるほど関連精度が上がる）
-->
