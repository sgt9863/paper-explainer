...
digest_chart_label: UHPLC-Q/TOF-MSによる同定成分の分類別内訳
digest_chart: [フラボノイド|37, 有機酸|21, リグナン|22]
summary: 中成薬「脳霊素カプセル(Naolingsu Capsule, NLSC、12生薬由来)」24バッチについて、HPLC-DAD指紋(25共通ピーク・類似度0.645–0.992)、UHPLC-Q/TOF-MSによる成分同定(フラボノイド37・有機酸21・リグナン22ほか)、多成分定量、PCA・PLS-DA・VIPによるケモメトリクス判別を組み合わせて品質マーカーを選定した品質評価の全訳(＋訳者補足)。指紋の類似度・同定成分・定量・判別まで網羅。
---
...
![図1（原論文 Figure 1）. 脳霊素カプセル(NLSC)の参照指紋(R)と構成12生薬のHPLC-DAD指紋クロマトグラム。](assets/naolingsu-fingerprint-chemometrics/fig1.jpeg)
...
![図2（原論文 Figure 2/3）. 24バッチのNLSCのHPLC指紋クロマトグラム（重ね描き）。](assets/naolingsu-fingerprint-chemometrics/fig2.jpeg)
...
![図3（原論文 Figure 4）. 24バッチNLSCのPCA-3Dスコアプロット（第1〜3主成分）。](assets/naolingsu-fingerprint-chemometrics/fig3.jpeg)
...
![図5（原論文 Figure 5）. 24バッチNLSCのPLS-DAスコアプロット（企業A〜Eが5象限に分離）。](assets/naolingsu-fingerprint-chemometrics/fig5.png)

![図6（原論文 Figure 6）. 24バッチNLSCのVIPプロット。VIP > 1 を主要差異成分の判定基準とし、RD・MPA・DS・SSB・EC・ICA・JB 等が上位。](assets/naolingsu-fingerprint-chemometrics/fig6.png)
...
5. M. Y. Jiang, J.-L. Cao, C.-B. Zhang et al., “A comprehensive strategy for quality evaluation of Wushe Zhiyang Pills by integrating UPLC-DAD ﬁngerprint and multi-ingredients rapid quantitation with UPLC-MS/MS technology,” Journal of Pharmaceutical and Biomedical Analysis, vol. 210, Article ID 153443, 2022. — [Google Scholarで探す](https://scholar.google.com/scholar?q=M.%20Y.%20Jiang%2C%20J.-L.%20Cao%2C%20C.-B.%20Zhang%20et%20al.%2C%20%E2%80%9CA%20comprehensive%20strategy%20for%20quality%20evaluation%20of%20Wushe%20Zhiyang%20Pills%20by%20integrating%20UPLC-DAD%20%EF%AC%81ngerprint%20and%20multi-ingredients%20rapid%20q)
